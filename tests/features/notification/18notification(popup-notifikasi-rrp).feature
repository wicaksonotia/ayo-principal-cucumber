Feature: 18. Popup Notifikasi (popup-notifikasi-RRP)

  Scenario Outline: As a user, I can Create Popup Notifikasi RRP
    ...
    When I click radio button RRP in Tipe Konten
    Then System should be click radio button RRP
    ...
    Examples:
      ...
      | popup notifikasi RRP Testing Reda | Yes            | No             | 18         | 50           | popup notifikasi RRP Testing Reda |
