Feature: 22. Push Notifikasi (push-notif-reguler)

  Scenario Outline: As a user, I can Create Push Notifikasi reguler
    ...
    Examples:
      ...
      | push notif reguler Testing Reda | push notif reguler Testing Reda | push notif reguler Testing Reda | push notif reguler Testing Reda |
