Feature: 16. Popup Notifikasi (popup-notifikasi-reguler)

  Scenario Outline: As a user, I can Create Popup Notifikasi Reguler
    ...
    Examples:
      ...
      | popup notifikasi reguler Testing Reda | Yes            | No             | 18         | 50           | popup notifikasi reguler Testing Reda |
