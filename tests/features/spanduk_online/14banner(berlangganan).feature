Feature: 14. InApp Banner Berlangganan (inapp-berlangganan)

  Scenario Outline: As a user, I can Create InApp Banner Berlangganan
    ...
    When I click Berlangganan in Status Berlangganan
    Then System should be click Berlangganan
