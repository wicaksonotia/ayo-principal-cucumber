...
import { pause, setDropdown } from "../../helper/commands";

//sub page containing specific selectors and methods for a specific page
class popupNotifReguler extends Page {
  ...
  async grupPengguna() {
    ...
    await setDropdown(this.selectCustomer, "Consumer");
  ...
  async tipeKonten() {
    ...
    await setDropdown(this.selectStatisticPage, "Static Page");
...
export default new popupNotifReguler();
