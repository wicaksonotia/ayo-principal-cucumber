...
class voucherTipeSemua extends Page {
  ...
  get calendarTglAwalVoucher() {
    return $('[formcontrolname="available_at"]');
  }
  get calendarTglKadaluarsaVoucher() {
    return $('[formcontrolname="expired_at"]');
  }
  ...
  get radioButtonSemua() {
    return $$(
      '[class="radio-button mat-radio-button mat-accent ng-star-inserted"]'
    );
  }
  get scrollReimburs() {
  ...
  get insertVoucher() {
    return $('[class="banner-image-template"]');
  }
  get inputIsiHalaman() {
  ...
  get buttonPublish2() {
    return $('[class="confirm mat-button ng-star-inserted"]');
  }
  get buttonPublish3() {
  ...
  async tipeCustomer() {
    await expect(this.checkboxSemuaTipeCustomer[1]).toBeClickable();
    await this.checkboxSemuaTipeCustomer[1].click();
    await browser.pause(5000);
  }
  ...
  async tombolPublish2() {
    await this.buttonPublish3.scrollIntoView();
    await expect(this.buttonPublish3).toBeClickable();
    await this.buttonPublish3.click();
  }
}
export default new voucherTipeSemua();
