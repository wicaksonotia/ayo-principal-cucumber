...
class flyingButtonRrp extends Page {
  ...
  async insertGambarBanner() {
    ...
    const remoteFilePath = path.join(
      __dirname,
      "../../files-to-upload/spanduk_online/6.png"
    );
  ...
  async tipeSpandukFlyingButton() {
    await expect(this.radioButtonFlyingButton[0]).toBeClickable();
    await this.radioButtonFlyingButton[0].click();
  }
...
export default new flyingButtonRrp();
