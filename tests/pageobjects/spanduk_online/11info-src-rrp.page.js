...
class infoSrcRrp extends Page {
  ...
  async tipeSpandukInfoSRC() {
    await expect(this.radioButtonInfoSRC[0]).toBeClickable();
    await this.radioButtonInfoSRC[0].click();
  }
