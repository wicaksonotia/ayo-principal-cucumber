...
class STWRewardXP extends Page {
  ...
  async btnRewardNonCoin() {
    await this.buttonRewardNonCoin[0].scrollIntoView();
  ...
  async inputXP(xp) {
    ...
    await this.inputCoin[1].setValue(xp);
    await browser.pause(1000);
  }

  async Delete1() {
    await this.buttonDelete[0].click();
  }

  async Delete2() {
    await this.buttonDelete[1].click();
  }
...
export default new STWRewardXP();
