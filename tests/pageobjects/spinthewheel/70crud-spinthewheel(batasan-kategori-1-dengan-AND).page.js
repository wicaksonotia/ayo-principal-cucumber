...
class stwBatasanKategori1AND extends Page {
  ...
  async pembatasanProdukdanKategori() {
    await this.radioButtonPembatasanProdukdanKategori[0].scrollIntoView();
    await this.radioButtonPembatasanProdukdanKategori[0].click();
    await browser.pause(3000);
  }
  ...
  async BatasanBerdasarkanKategori() {
    ...
    await this.optionBatasanBerdasarkanKategori[8].scrollIntoView();
    await this.optionBatasanBerdasarkanKategori[8].click();
    await this.optionBatasanBerdasarkanKategori[11].click();
    await browser.keys("Escape");
  }

  async nilaiTransaksiMinimal1(nilai_transaksi_minimal1) {
    await this.inputNilaiTransaksiMinimal[0].scrollIntoView();
    await this.inputNilaiTransaksiMinimal[0].setValue(nilai_transaksi_minimal1);
  }

  async nilaiTransaksiMinimal2(nilai_transaksi_minimal2) {
    await this.inputNilaiTransaksiMinimal[1].setValue(nilai_transaksi_minimal2);
  ...
  async nonCoin(noncoin1) {
    await this.inputCoin[2].setValue(noncoin1);
    await browser.pause(1000);
  }

  async RewardXP() {
    await this.buttonReward[1].scrollIntoView();
    await this.buttonReward[1].click();
    await browser.pause(1000);
  }

  async XP1(xp1) {
    await this.inputCoin[3].setValue(xp1);
    await browser.pause(1000);
  }

  async XP2(xp2) {
    await this.inputCoin[4].setValue(xp2);
    await browser.pause(1000);
  }
...
export default new stwBatasanKategori1AND();
