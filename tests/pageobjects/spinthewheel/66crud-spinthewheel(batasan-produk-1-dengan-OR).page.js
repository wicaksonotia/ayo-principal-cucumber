...
class stwBatasanProduk1OR extends Page {
  get titlePage() {
  ...
  async Coin1(coin1) {
    ...
    await this.inputCoin[2].setValue(coin1);
    await browser.pause(1000);
  }

  async Coin2(coin2) {
    await this.inputCoin[3].setValue(coin2);
    await browser.pause(1000);
  }

  async XP(xp) {
    await this.inputCoin[4].setValue(xp);
    await browser.pause(1000);
  }
...
export default new stwBatasanProduk1OR();
