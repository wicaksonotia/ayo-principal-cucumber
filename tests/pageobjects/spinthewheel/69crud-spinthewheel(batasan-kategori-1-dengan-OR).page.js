...
class stwBatasanKategori1OR extends Page {
  ...
  async OR() {
    await this.radioButtonOR[5].click();
    await browser.pause(1000);
  }
  ...
  async nonCoin1(noncoin1) {
    await this.inputCoin[2].setValue(noncoin1);
    await browser.pause(1000);
  }

  async nonCoin2(noncoin2) {
    await this.inputCoin[3].scrollIntoView();
    await this.inputCoin[3].setValue(noncoin2);
    await browser.pause(1000);
  }
...
export default new stwBatasanKategori1OR();
